...
void main() {
  ...
  group('Query with Postgre Driver', () {
    group('when .where', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima');
        expect(
          query.statement,
          'SELECT * FROM users WHERE firstname = \'Chima\';',
        );
      ...
      test('of level 2', () {
        final query =
            Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').where('lastname', '=', 'Precious');
        expect(
          query.statement,
      ...
      test('of level 3', () {
        final query = Query.query('users', postgresSqlDriver)
            .where('firstname', '=', 'Chima')
            .where('lastname', '=', 'Precious')
            .where('age', '=', 22);
    ...
    group('chained with `.orWhere`', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').orWhere('age', '=', 203);
    ...
    group('chained with', () {
      test('.whereNull', () {
        final query = Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereNull('age');
      ...
      test('.whereNotNull', () {
        final query = Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereNotNull('age');
      ...
      test('.whereIn', () {
        final query =
            Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereIn('age', [22, 24, 25]);
      ...
      test('.whereNotIn', () {
        final query =
            Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereNotIn('age', [22, 24, 25]);
      ...
      test('.whereLike', () {
        final query =
            Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereLike('lastname', 'hello%');
      ...
      test('.whereNotLike', () {
        final query =
            Query.query('users', postgresSqlDriver).where('firstname', '=', 'Chima').whereNotLike('lastname', 'hello%');
    ...
    group('when handwritten operator', () {
      ...
      test('>', () {
        final query = Query.query('users', postgresSqlDriver).where('age', '>', 23);
      ...
      test('>=', () {
        final query = Query.query('users', postgresSqlDriver).where('age', '>=', 223);

        expect(query.statement, 'SELECT * FROM users WHERE age >= 223;');
      });

      test('<=', () {
        final query = Query.query('users', postgresSqlDriver).where('age', '<=', 34.3);

        expect(query.statement, 'SELECT * FROM users WHERE age <= 34.3;');
      });

      test('in', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'in', ['Accra', 'Tema']);
      ...
      test('not in', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'not in', ['Accra', 'Tema']);
      ...
      test('null', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'null');
      ...
      test('not null', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'not null');
      ...
      test('like', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'like', "MerryC");
      ...
      test('not like', () {
        final query = Query.query('users', postgresSqlDriver).where('places', 'not like', "MerryC");
      ...
      test('between', () {
        final query = Query.query('users', postgresSqlDriver).where('age', 'between', [22, 30]);
      ...
      test('not between', () {
        final query = Query.query('users', postgresSqlDriver).where('age', 'not between', [22, 30]);
    ...
    group('when .whereIn', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereIn('firstname', ['Accra', 'Tamale']);
    ...
    group('when .whereNotIn', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereNotIn('firstname', ['Accra', 'Tamale']);
    ...
    group('when .whereBetween', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereBetween('age', [22, 70]);
    ...
    group('when .whereNotBetween', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereNotBetween('age', [22, 70]);
      ...
      test('of level 3', () {
        final query = Query.query('users', postgresSqlDriver).whereIn('places', ['Accra', 'Tamale']).whereNotBetween(
            'lastname', [22, 48]).where('names', 'like', 'Hello%');
    ...
    group('when .whereLike', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereLike('firstname', 'Names%%');
      ...
      test('of level 2', () {
        final query =
            Query.query('users', postgresSqlDriver).whereLike('places', 'Chima**').where('lastname', '=', 'Precious');
    ...
    group('when .whereNotLike', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereNotLike('firstname', 'Names%%');
    ...
    group('when .whereNull', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereNull('firstname');
      ...
      test('of level 2', () {
        final query = Query.query('users', postgresSqlDriver).whereNull('places').where('lastname', '=', 'Precious');
    ...
    group('when .whereNotNull', () {
      test('of level 1', () {
        final query = Query.query('users', postgresSqlDriver).whereNotNull('firstname');
      ...
      test('of level 2', () {
        final query = Query.query('users', postgresSqlDriver).whereNotNull('places').where('lastname', '=', 'Precious');
